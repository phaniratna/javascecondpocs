...
public class EmployeeController {
	...
	@PostMapping(value = "/createEmployee", consumes = { MediaType.APPLICATION_XML_VALUE,
	...
	public ResponseEntity<?> createEmployee(@RequestBody Employee employee) {
		try {
			...
			if (employee.getName().isEmpty() || employee.getName() == null || employee.getCity().isEmpty()
					|| employee.getCity() == null || employee.getPhone() == null || employee.getSalary() == null) {
	...
	public ResponseEntity<?> getEmployeeById(@PathVariable("id") Integer id) {
		try {
			...
			logger.info(" records not found with id ", id, e);
			Response response = new Response();
	...
	public ResponseEntity<?> updateEmployee(@RequestBody Employee employee) {
		try {
			...
			if (employee.getId() == null || employee.getName().isEmpty() || employee.getName() == null
				...
				logger.info(" employee request feilds are null");
				Response response = new Response();
				response.setMessage("employee  feilds shouldn't null");
				response.setStatusCode("422");
				return new ResponseEntity<>(response, HttpStatus.UNPROCESSABLE_ENTITY);
			}
	...
	public ResponseEntity<?> getAllEmployeeInfo(
		...
		if (pageNo == null || sizePerPage == null) {
			...
			response.setMessage("page and size shouldnot be null");
