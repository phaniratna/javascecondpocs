...
public class EmployeeServiceTests {
	...
	public void getAllEmployeeDetails_PageNumber_PageSize_search() {
		...
		when(employeeRepository.findByNameContaining("ganesh", paging)).thenReturn(page);

		EmployeeResponseData allEmployeeDetails = employeeService.getAllEmployeeDetails("ganesh",1, 3);
